module.exports = (m) => {
   ...
   if (setting) {
      if (!('setmenu' in setting)) setting.setmenu = 2
      ...
      if (!('sk_pack' in setting)) setting.sk_pack = 'Siesta.MD'
      if (!('sk_author' in setting)) setting.sk_author = 'ai hengker'
      ...
      if (!('owners' in setting)) setting.owners = ['62888980870067', '6288980870067', '6288980870067']
      if (!('mods' in setting)) setting.mods = []
      if (!('link' in setting)) setting.link = 'https://chat.whatsapp.com/KbgGdT1cV3rD5JzJDZryis'
      if (!('cover' in setting)) setting.cover = 'https://telegra.ph/file/96709dfe857f5f38562c2.jpg'
      ...
      if (!('footer' in setting)) setting.footer = 'S I E S T A  B O T'
   } else {
      global.db.setting = {
         setmenu: 1,
         autobackup: true,
         ...
         prefix: ['.', '#', '!', '/'],
         onlyprefix: '+',
         owners: ['6288980870067', '6288980870067', '6288980870067'],
         mods: [],
         link: 'https://chat.whatsapp.com/KbgGdT1cV3rD5JzJDZryis,
         cover: 'https://telegra.ph/file/96709dfe857f5f38562c2.jpg',
         header: 'JUST FOR FUN',
         msg: 'I am a Whatsapp BOT, use a bot in private chat so that bots can respond quickly.',
         footer: 'ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ ᴡᴀɴɢsᴀғ ʙᴏᴛ ᴍᴀᴅᴇ ʙʏ ᴀɪ ッ'
      }
   }
}
