...
Socket = (...args) => {
      ...
      return client.generateMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               ...
               sourceUrl: properties.url || global.db.setting.link
            }
         }
      }, {
         quoted
   ...
   client.limit = (m) => {
      ...
      if (!user.lastlimit) user.lastlimit = 0
      let timeToReset = global.resetTime
      let reset = new Date(user.lastlimit + timeToReset)
      let timeout = reset - new Date()
      if (new Date - user.lastlimit > timeToReset) {
      ...
      return client.sendMessage(jid, {
         ...
         contextInfo: {
            ...
            externalAdReply: {
               ...
               sourceUrl: 'https://wa.me/62888980870067?text=bang+upgrade+premium+biar+unlimited+limit'
            }
         }
      }, {
         quoted
