exports.run = {
   ...
   async: async (m, {
      ...
      try {
         ...
         let buttons = [{
               buttonId: `${isPrefix}gflimit ${user}`,
               buttonText: {
                 displayText: 'GIFT LIMIT'
               },
              type: 1
              }, {
                 buttonId: `${isPrefix}tfpoint ${user}`,
                 buttonText: {
                   displayText: 'TF SALDO'
               },
              type: 1
            }]
            let now = new Date() * 1
            ...
            caption += `	›  *Saldo* : Rp. ${Func.h2k(Func.formatNumber(users.point))}\n`
